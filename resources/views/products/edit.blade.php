...
<body>
    <div class="container">
        ...
        <form action="{{ route('products.update',$product) }}" method="POST">
            ...
            <textarea name="description" id="" cols+"30" rows="10" required>{{$product->description}}</textarea><br>
            <label for="price">Цена продукта</label><br>
            <input id="price" type="number" name="price" required value="{{$product->description}}"><br>
